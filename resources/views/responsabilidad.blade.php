<x-layout :deportes="$deportes" :user="$user">
    <main class="main-responsabilidad">
        <div>
            ...
            <ul>
                <li>Garantizar la disponibilidad de las instalaciones para los jugadores.</li>
                <li>Cumplir con los acuerdos establecidos con los participantes.</li>
                <li>Administrar adecuadamente los fondos de inscripción.</li>
                <li>Resolver cualquier problema que surja durante el desarrollo de la liga.</li>
            </ul>

            <h3>Responsabilidades de los Jugadores:</h3>
            <ul>
                <li>Pagar la inscripción según lo acordado.</li>
                <li>Participar activamente en la liga y seguir las reglas establecidas.</li>
                <li>Reportar cualquier inconveniente o disputa al organizador de manera oportuna.</li>
                <li>Respetar a los demás participantes y las instalaciones.</li>
            </ul>
