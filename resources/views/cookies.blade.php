     ...
     <div class="col-xl-10 mx-auto">
         <div class="paper">
             <header class="text-center">
                 ...
                 <h4><span class="blanc-space ng-binding">www.sportleaguemanager.com</span></h4>
             </header>
             <div>
                 ...
                 <div ng-show="hasPersonalCookies == 'Sí'" class="">
                     ...
                     <p>Son aquellas cookies que son enviadas al ordenador o dispositivo del Usuario y gestionadas exclusivamente por <span class="blanc-space ng-binding">Creador de ligas deportivas</span> para el mejor funcionamiento del Sitio Web. La información que se recaba se emplea para mejorar la calidad del Sitio Web y su Contenido y su experiencia como Usuario. Estas cookies permiten reconocer al Usuario como visitante recurrente del Sitio Web y adaptar el contenido para ofrecerle contenidos que se ajusten a sus preferencias.</p>
                 </div>
                 <div class="thirdCookies ng-hide" ng-show="hasThirdCookies == 'Sí'">
                     <h4>Cookies de terceros</h4>
                     <p>Son cookies utilizadas y gestionadas por entidades externas que proporcionan a <span class="blanc-space ng-binding">Creador de ligas deportivas</span> servicios solicitados por este mismo para mejorar el Sitio Web y la experiencia del usuario al navegar en el Sitio Web. Los principales objetivos para los que se utilizan cookies de terceros son la obtención de estadísticas de accesos y analizar la información de la navegación, es decir, cómo interactúa el Usuario con el Sitio Web.</p>
                 ...
                 <p>Este documento de Política de Cookies ha sido creado mediante el generador de <a class="text-body text-decoration-none" href="https://textos-legales.edgartamarit.com/">plantilla de política de cookies web gratis</a> online el día 13/05/2024.</p>
             </div>
         </div>
     </div>
 </div>
